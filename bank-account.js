class BankAccount {
  ...
  printStatement() {
    ...
    for(let i = 0; i < this.transactions.length; i ++){
      output.unshift(`\n${this.getDate()} || ${this.valueConverter(this.transactions[i].credit)} || ${this.valueConverter(this.transactions[i].debit)} || ${this.valueConverter(this.transactions[i].balance)}`);
    }
